...
import com.minecraftdimensions.gesuitchat.commands.*;
import com.minecraftdimensions.gesuitchat.commands.channel.*;
import com.minecraftdimensions.gesuitchat.commands.factions.FactionChatAllyCommand;
import com.minecraftdimensions.gesuitchat.commands.factions.FactionChatCommand;
import com.minecraftdimensions.gesuitchat.commands.factions.FactionChatFactionCommand;
import com.minecraftdimensions.gesuitchat.commands.towny.TownyChatCommand;
import com.minecraftdimensions.gesuitchat.commands.towny.TownyChatNationCommand;
import com.minecraftdimensions.gesuitchat.commands.towny.TownyChatTownCommand;
import com.minecraftdimensions.gesuitchat.listeners.*;
...
public class geSuitChat extends JavaPlugin {

    public static String OUTGOING_PLUGIN_CHANNEL = "geSuitChat";
    public static String INCOMING_PLUGIN_CHANNEL = "geSuitChat";
    public static geSuitChat instance;
    ...
    private void registerCommands() {
        ...
        getCommand( "namecoloroff" ).setExecutor( new NameColorOffCommand() );
